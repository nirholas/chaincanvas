...
Draw compact monochrome pixel art and export an onchain-ready SVG payload.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. ChainCanvas explores a focused consumer use of that space while making the wire budget visible.
